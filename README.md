...
Лендинг автосервиса Arqa (Кокшетау, ул. Шагалалы, 1/1): React 19 + Vite 7 + Tailwind 4, бэкенд — Express (Node 22). Форма записи отправляет заявки владельцу в Telegram.
